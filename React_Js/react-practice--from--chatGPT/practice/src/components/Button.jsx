...
function Button({clickEvent, testState, setfunc}) {
  ...
  // console.log("test state IN Child", testState)



  return (
    <div>
        <button onClick={clickEvent} >click me! from child component</button>
        {/* <button onClick={abc} >click me! from child component eeee</button> */}
        {/* <button onClick={()=> setFirst(false)}>child</button> */}
