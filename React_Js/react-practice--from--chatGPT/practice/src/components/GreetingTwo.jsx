...
// props (object)
// props: aik object hota hay kissi b functional component ka, jis k paas properties hoti hayn agar component k liye pass ki gai hun.
...
// function GreetingTwo({name, message}) {
//   return (
//     <div>
//         <h1>{name}</h1>
//         <p>{message} </p>
