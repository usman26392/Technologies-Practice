...
export default function NumberCounter() {
    ...
    return (
        <div>
            ...
            <div>
                <button onClick={() => dispatchCounter("incrementNumber")}>Increment number!</button>
                <button onClick={() => dispatchCounter("decrementNumber")} >Decrement number!</button>
                <button onClick={() => dispatchCounter("resetToZero")}>Reset to zero !</button>
            </div>
        </div>
    )
}