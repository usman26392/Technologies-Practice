/**
 * ------------------- Variables -----------------------
 * variable, jub b hum koi variable declare kartay hayn
 * toh iska matlab yey hay k hum nay memory k kisi hissay ka
 * name rakh diya hay:
 * or iska mazeed matlab ye hay k , jo variable declare hota 
 * wo asal may "memory address" hota hay jis may data store hota hay.
 * VariableName = memoryAddressNumber
 */
