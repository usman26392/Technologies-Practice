        ...
        <section class="inner-first thm-py-85 thm-pb-175">
            <div class="container">
                <div class="twocol-row">
                    <div class="col-100">
                        <h3 class="h3 animate" data-animation="animate__fadeInUp" data-duration="200"> A Diversified Portfolio Of Businesses</h3>
                    </div>
                    <div class="col-40">
                        <p class="animate" data-animation="animate__fadeInUp" data-duration="300"> From acquiring and creating innovative restaurant concepts to bespoke catering, quality food retailing, and distribution of food products, we have built a portfolio of market-leading businesses.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="stroke-figure  thm-py-75" id="Retail">
                ...
                <div class="stroke-figure__panel">
                    <div class="stroke-figure__panel__img img__observer__two">
                        <img src="/assets/images/bussiness-sectors/retail.jpg" class="observer__child" />
                    </div>
                    <div class="stroke-figure__panel__stroke">
                        <span>Retail</span>
                    </div>
                ...
                <div class="container">
                    <div class="twocol-row">
                        ...
                        <div class="col-50">
                            <div class="stroke-figure__panel">
                                <div class="stroke-figure__panel__img img__observer__one">
                                    <img src="/assets/images/bussiness-sectors/catering.jpg" alt="restaurant" class="observer__child" />
                                </div>
                                <div class="stroke-figure__panel__stroke">
                                    <span> Catering</span>
                                </div>
